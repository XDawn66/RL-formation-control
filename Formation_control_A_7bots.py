...
def run_sim():
    ...
    model = SAC.load("models/sac_gamma_7bots_tran_II/test_50k.zip",myenv, tensorboard_log="./sac_car_env/")
    ...
    #     model.save(f"models/sac_gamma_7bots_tran_II/test_{i*25}k")
...
if __name__ == "__main__":
    ...
    FORMATION_OFFSET = np.array([[0, 50], [25, 75], [75,75], [100,60], [100,40], [25,0], [75,0]])
