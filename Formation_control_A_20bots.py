...
# )
    ...
    model = SAC.load("models/sac_gamma_20bots_tran_I/test_100k.zip",myenv, tensorboard_log="./sac_car_env/")
    ...
    #     model.save(f"models/sac_gamma_10bots_tran_I/test_{i*25}k")
